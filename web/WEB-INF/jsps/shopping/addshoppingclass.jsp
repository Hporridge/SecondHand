        ...
        <div class="main-wrap">
            ...
            <div class="user-info">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">商品分类管理</strong></div>
                </div>
                <hr/>
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                    <c:forEach items="${requestScope.shoppingclass}" var="list" varStatus="num">
                        <tr>
                            <td>
                                <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='2'><i class="layui-icon">&#xe605;</i></div>
                            </td>
                            <td>${list.id}</td>
                            <td>${list.shoppingclass_name}</td>
                            <td>${list.shoppingclass_desc}</td>
                            <td class="td-manage">
                                <a title="增加"  href='shopping/add'>
                                    <i class="layui-icon">&#xe654;</i>
                                </a>
                                <a title="编辑"  href='shopping/edit?id=${list.id}'>
                                    <i class="layui-icon">&#xe642;</i>
                                </a>
