					...
					<div class="am-container header" style="margin-left: -400px;margin-top: 30px">
						...
						<div class="nav white">
							<div class="search-bar pr">
								...
								<form>
									<input id="searchInput" name="index_none_header_sysc" type="text" placeholder="搜索你想找的商品" autocomplete="off">
			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<hr/>
						<!--用户信息  通过列表的形式展示 用户  用户名，邮箱账号 可能需要用到分页，就是查询所有用户，在末尾可以编辑，跳到编辑页面-->
						<table class="layui-table">
							...
							<tbody>
							<c:forEach items="${requestScope.user_list}" var="list" varStatus="num">
								<tr>
									<td>
									...
									<td>${list.address}</td>
									<td class="td-manage">
										<a title="编辑"  href='user/edit?id=${list.id}'>
