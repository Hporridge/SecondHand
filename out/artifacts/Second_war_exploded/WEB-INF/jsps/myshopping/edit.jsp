		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<!--进度条-->
				<form enctype="multipart/form-data" method="post" action="../myshopping/edit">
						...
						<div class="refund-main">
							<div class="item-comment">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" name="money" value="${list.money}">
									</div>
								</div>
								<div class="am-form-group">
									<label  class="am-form-label">商品介绍<span></span></label>
									<div class="am-form-content">
										<textarea placeholder="${list.content}" name="content"></textarea>
									</div>
								</div>
									...
									<div class="am-form-content">
										<select id="shopping_type" name="shopping_type" class="valid" >
											<c:forEach items="${requestScope.shopingclass_list}" var="line" varStatus="stat">
												<option value="${line.id}" <c:if test="${list.shopping_type == line.id }">selected</c:if>>${line.shoppingclass_name}</option>
											</c:forEach>
										</select>
									</div>
								</div>
