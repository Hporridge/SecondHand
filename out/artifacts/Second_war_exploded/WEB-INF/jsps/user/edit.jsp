...
<div class="center">
        ...
        <div class="main-wrap">
            ...
            <div class="user-info">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">用户编辑</strong></div>
                </div>
                <hr/>
                <!--用户信息 用户名 邮箱 需要提交按钮-->
                <div class="info-main">
                    <form class="am-form am-form-horizontal" method="POST" id="deptForm"  action="../user/edit">
                        <input type="hidden" name="id" id="id" value="${list.id }" >
                        <div class="am-form-group">
                            <label  class="am-form-label">用户名</label>
                            <div class="am-form-content">
                                <input type="text" id="username" name="username" value="${list.username}">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input id="phone" name="phone" placeholder="Phone" type="text" value="${user.phone}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input id="address" name="address" placeholder="Address" type="text" value="${user.address}">
                            </div>
                        </div>
                        <div class="am-cf">
    ...
    <aside class="menu">
        <ul>
            ...
            <li class="person">
                <a href="../addshoppingclass" style="color: #aa4b00">商品管理</a>
            </li>
            <li class="person">
