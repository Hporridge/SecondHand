        ...
        <div class="main-wrap">
            ...
            <div class="user-info">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">商品分类编辑</strong></div>
                </div>
                <hr/>
                <!--用户信息 用户名 邮箱 需要提交按钮-->
                <div class="info-main">
                    <form class="am-form am-form-horizontal" method="POST" id="deptForm"  action="../shopping/edit">
                        <input type="hidden" name="id" id="id" value="${list.id}" >
                        <div class="am-form-group">
                            <label  class="am-form-label">商品分类名称</label>
                            <div class="am-form-content">
                                <input type="text" id="shoppingclass_name" name="shoppingclass_name" value="${list.shoppingclass_name}">

                            </div>
                        </div>
                        <div class="am-form-group">
                            <label class="am-form-label">商品分类描述</label>
                            <div class="am-form-content">
                                <input type="text" id="shoppingclass_desc" name="shoppingclass_desc"  value="${list.shoppingclass_desc}">
                            </div>
                        </div>
                        <div class="am-cf">
