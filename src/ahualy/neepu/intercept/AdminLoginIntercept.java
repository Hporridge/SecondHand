package ahualy.neepu.intercept;
...
public class AdminLoginIntercept implements HandlerInterceptor {
     ...
     * 定义不需要拦截的请求
     */
    private static final String[] IGNORE_URI = {"/login", "/register", "/register_validate", "/login_validate", "/shopping"};
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (!flag) {
            ...
            if (user == null) {
                /** 如果用户没有登录，跳转到登录页面 */
                request.setAttribute("ms", "请先登录再访问网站!");
